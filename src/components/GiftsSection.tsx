    ...
    <section id="regalos" className=" ">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-4">
          <h2 className="text-5xl md:text-6xl font-serif text-gold mb-4 old-standard-regular">
            LISTA DE REGALOS
          </h2>
          <p className="text-lg text-muted-foreground raleway max-w-2xl mx-auto">
            ...
            algo, aquí tienes algunas opciones que nos ayudarán a comenzar
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <Card className="shadow-card  border-0 text-center">
            <CardContent className="">
              ...
              <h3 className="text-2xl lora font-serif text-gold mb-2">
                Mesa de Regalos
              </h3>
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://mesaderegalos.liverpool.com.mx/milistaderegalos/51806107",
                    "_blank"
                  )
                }
              >
