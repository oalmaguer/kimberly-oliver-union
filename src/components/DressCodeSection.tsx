    ...
    <section id="vestimenta" className="py-10 bg-creamw">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-2xl font-serif text-muted-foreground old-standard-regular mb-2">
            ETIQUETA
          </p>
        ...
        {/* Women's Style Image */}
        <div className="mb-16">
          <h3 className="text-5xl font-serif text-gold mb-6 text-center tangerine-regular">
            Para Ellas
          </h3>
        ...
        <div className="bg-cream rounded-lg p-8">
          <div className="mt-8 p-4 bg-gold/10 rounded-lg">
            <p className="text-center text-sm font-sans text-gold-dark">
              <strong>Recuerda:</strong> La ceremonia será al aire libre. Te
              sugerimos considerar el clima y usar calzado apropiado para
              caminar en jardín.
            </p>
            <p className="text-center mt-4 text-sm font-sans ">
              <strong>No Niños:</strong> La ceremonia será un evento para
              adultos.
            </p>
          </div>
        </div>
